...
public class Apanel extends JPanel {
	public Apanel(){//第一位开奖号码的走势面板
		...
		add(contentPane, BorderLayout.CENTER);//添加背景面板到第一位开奖呈码走势面板的中间
	...
	//"各个数字在该位所出现的百分比"标签
		...
		progressBar_2.setStringPainted(true);//设置与"2:"标签对应的进度条呈现的进度字符串
	...
	protected void do_button_actionPerformed(ActionEvent e){
		//创建"第一位开奖号码超走势图"折线图窗体对象
		ALineChart chart=new ALineChart(null,"第一位开奖号码走势图");
		chart.pack();//调整窗口的大小，以适合折线图对象的首选大小和布局
		RefineryUtilities.centerFrameOnScreen(chart);//将折线对象置于屏幕中间
